...
class CoachingCue:
    ...
    zone_label: str = ""
    voice_key: str = ""
    # urgent_brake | caution_lift | throttle_go | neutral
    state: str = "neutral"
...
class CoachingZone:
    ...
    name: str
    sequence_index: int
    segment_type: str   # brake_zone | lift_zone | light_brake | throttle_pickup | wait_rotate | apex | exit | straight
...
@dataclass
class LapCoachingSummary:
    lap_number: int
    zone_observations: List[LiveZoneObservation] = field(default_factory=list)
    corrections_generated: List[str] = field(default_factory=list)
    valid: bool = True
